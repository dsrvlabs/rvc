...
use rvc_signer_bin::http_api::{router, AuditCfg, Web3SignerState};
use rvc_signer_bin::proto::signer_v2::signer_service_server::SignerService as SignerServiceV2;
use rvc_signer_bin::proto::signer_v2::{
...
fn http_state(s: &Shared) -> Web3SignerState {
    Web3SignerState {
        ...
        metrics: Arc::new(rvc_signer_bin::metrics::SignerMetrics::new()),
