//! RED test: sign_attestation returns BlockedByDoppelganger and commits NO slashing row.
//!
...
async fn test_sign_attestation_blocked_by_doppelganger_no_row_committed() {
    ...
    let result = gate.sign_attestation(&pubkey, source_epoch, target_epoch, signing_root, GVR).await;
